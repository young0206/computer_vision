        ...
        def filter_predictions(batch_item):
            ...
            def top_k():
                return tf.gather(params=filtered_predictions,
                                 indices=tf.math.top_k(filtered_predictions[:, 1], k=self.tf_top_k, sorted=True).indices,
                                 axis=0)
            def pad_and_top_k():
                ...
                return tf.gather(params=padded_predictions,
                                 indices=tf.math.top_k(padded_predictions[:, 1], k=self.tf_top_k, sorted=True).indices,
                                 axis=0)
