...
focal_alpha = 0.25
def build_matcher():
    assert matcher_type in ['HungarianMatcher', 'SimpleMinsumMatcher'], "Unknown args.matcher_type: {}".format(args.matcher_type)
    if matcher_type == 'HungarianMatcher':
        ...
        raise NotImplementedError("Unknown args.matcher_type: {}".format(matcher_type))