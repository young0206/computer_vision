...
def build_deformable_transformer():
    ...
    if decoder_layer_noise:
        ...
        decoder_query_perturber=RandomBoxPerturber(
                x_noise_scale=dln_xy_noise, y_noise_scale=dln_xy_noise, 
                w_noise_scale=dln_hw_noise, h_noise_scale=dln_hw_noise)
    ...
    return DeformableTransformer(
        ...
        num_unicoder_layers=unic_layers,
