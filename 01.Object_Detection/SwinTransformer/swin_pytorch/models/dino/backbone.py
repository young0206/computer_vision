...
def build_backbone():
    ...
    if backbone in ['swin_T_224_1k', 'swin_B_224_22k', 'swin_B_384_22k', 'swin_L_224_22k', 'swin_L_384_22k']:
        pretrain_img_size = int(backbone.split('_')[-2])
        backbone = build_swin_transformer(backbone, \
                    pretrain_img_size=pretrain_img_size, \
                    out_indices=tuple(return_interm_indices), \
                dilation=dilation, use_checkpoint=use_checkpoint)
        ...
        pretrainedpath = pretrained_dir+'/swin_large_patch4_window12_384_22k.pth'
    ...
    elif backbone in ['convnext_xlarge_22k']:
        backbone = build_convnext(modelname=backbone, pretrained=True, out_indices=tuple(return_interm_indices),backbone_dir=args.backbone_dir)
